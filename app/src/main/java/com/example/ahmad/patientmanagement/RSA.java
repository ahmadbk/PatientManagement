...
public class RSA {
    ...
    public RSA(){
        ...
        BigInteger privateExponent = new BigInteger("");
        publicKey = getKey(yourModulus, exponent);
        privateKey = getPrivateKey(myModulus, privateExponent);
