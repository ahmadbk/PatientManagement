                    ...
                    else if(output.equalsIgnoreCase("patient"))
                    {
                        ...
                        try {
                            ...
                            while (count<jsonArray.length())
                            {
                                ...
                                StaffLogin.patientDetails = new PatientDetails(Integer.parseInt(tag_id), firstname,surname,dob,dA,eC,g,pN,a,cname,smoker,alcoholic,false);
                                count++;
                            }
...
//----------------------------------------------------------------------------------------------------------------------
                        ...
                        try {
                            ...
                            int count = 0;
                            String sD,eD,docFN,docLN,mN,quantity,s,morning,afternoon,evening,mealRelation;
                            while (count<jsonArray.length())
                            {
                                JSONObject JO = jsonArray.getJSONObject(count);
